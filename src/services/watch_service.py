...
class WatchService:
    ...
    def create_watch(self, watch_id: int, seller_id: int, name: str, brand: str, price: float, origin: str, model: str, produce_at , status: str, image: str, report_id: int) -> Watch:
    ...
    def update_watch(self, watch_id: int, seller_id: int, name: str, brand: str, price: float, origin: str, model: str, produce_at , status: str, image: str, report_id: int) -> Watch:
        watch = Watch(watch_id=watch_id, seller_id=seller_id, name=name, brand=brand, price=price, origin=origin, model=model, produce_at=produce_at, status=status, image=image, report_id=report_id)
