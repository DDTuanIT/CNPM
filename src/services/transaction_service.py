...
class TransactionService:
    ...
    def create_transaction(self, transaction_id: UNIQUEIDENTIFIER, buyer_id: UNIQUEIDENTIFIER, watch_id: UNIQUEIDENTIFIER, watch_price: float, purchase_date, transaction_status: str, escrow: float, feedback_id: UNIQUEIDENTIFIER) -> Transaction:
    ...
    def get_transaction(self, transaction_id: UNIQUEIDENTIFIER) -> Optional[Transaction]:
        return self.repository.get_by_id(transaction_id)

    def list_transactions(self) -> List[Transaction]:
        return self.repository.list()

    def update_transaction(self, transaction_id: UNIQUEIDENTIFIER, buyer_id: UNIQUEIDENTIFIER, watch_id: UNIQUEIDENTIFIER, watch_price: float, purchase_date, transaction_status: str, escrow: float, feedback_id: UNIQUEIDENTIFIER) -> Transaction:
        transaction = Transaction(transaction_id=transaction_id, buyer_id=buyer_id, watch_id=watch_id, watch_price=watch_price, purchase_date=purchase_date, transaction_status=transaction_status, escrow=escrow, feedback_id=feedback_id)
